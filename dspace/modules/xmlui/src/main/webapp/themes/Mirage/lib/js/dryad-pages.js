...
jQuery(document).ready(function() {
    ...
    if ($currencySelector.length === 1) {
		...
		jQuery.each(['.msg-less_than_10_million', '.msg-greater_than_10_million', '.msg-advocate-all-organizations', '.msg-inst_level1', '.msg-inst_level3', '.msg-inst_level2', '.msg-inst_level0'], function(i,klass) {
